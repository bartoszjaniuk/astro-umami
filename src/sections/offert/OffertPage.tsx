...
const panels = [
  ...
  //   content:
  //     "Wyeliminujemy produkty, które Ci szkodzą. Pokażę Ci jak komponować smaczne posiłki bez produktów alergizujących, po których będziesz się świetnie czuć. Alergia nie będzie dla Ciebie już tak kłopotliwa jak dotychczas!",
  // },
  // {
